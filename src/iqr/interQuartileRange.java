        ...
        for(int element : elements){
            ...
            if(sum<=midpoint){
                ...
                if(isodd){
                    ...
                    amount_left_from_current_frequency-=1;
                    medianHasNotBeenRemoved = false;
                    System.out.println("ehid" +element);
                    return element;
                    //update current sum
                    //current_sum+=1;
                }
...
//            }
            ...
            System.out.println("first quartile: "+lowerQuartile);
            //print it
            ...
            //second half
            int[] secondHalf_elements = new int[interQuartileRange.firstHalf.size()];
            ...
            System.out.println("second quartile: "+ upperQuartile);
